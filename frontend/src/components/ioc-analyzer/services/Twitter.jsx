  ...
  return (
    <>
      <TableRow key="twitter_row">
        ...
        <TableCell>
          {" "}
          {result.length > 0 ? "At least " : null} {result[0]["count"]} Tweets
          within the last 7 days{" "}
        </TableCell>
        <TableCell
          bgcolor={result && result.length > 0 ? "orange" : "green"}
        ></TableCell>
      </TableRow>
      <TableRow>
        <TableCell
                  ...
                  return (
                    <React.Fragment key={index + "_tweet_fragment"}>
                      ...
                      >
                        ...
                        <p
                          sx={{ maxWidth: "100px", overflowWrap: "break-word" }}
                        >
                          {tweet["text"]}
                        </p>
                      </Card>
