...
export default function Pulsedive(props) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            try {
                const url = 'http://localhost:8000/api/' + props.type + '/pulsedive?ioc=' + encodeURIComponent(props.ioc);
  ...
  return (
    <>
        ...
        summary={
            ...
            "Risk: " + result['results'][0]['risk'].charAt(0).toUpperCase() +
            result['results'][0]['risk'].slice(1) : 'Not found'
            }
