  ...
  return (
    <>
      ...
      >
        <CardContent sx={{ "& > *": { my: 2 } }}>
          <ul style={listStyle}>
            <li>If your list consists of a single element, don't use a list</li>
            <li>Use only lowercase identifiers</li>
            <li>
              Put comments on lines if you like to (use 2 spaces to separate the
              expression from your comment, e.g. - 'cmd.exe' # command line)
            </li>
            <li>
