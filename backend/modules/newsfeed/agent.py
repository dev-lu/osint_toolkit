...
from database.crud.newsfeed_crud import (
    get_recent_news_articles,
    get_news_article_by_id,
)
from database.crud.apikey_settings_crud import get_apikey
from database.crud.cti_settings_crud import get_cti_settings
